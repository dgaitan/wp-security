 ...
 *
 *   Scenario: Activation creates all five custom tables
 ...
 *     remediation_log (Sprint 9), and maintenance_notes (Sprint 10)
 *
...
final class MigratorTest extends TestCase {
	...
	public function test_run_creates_all_five_tables_via_dbdelta(): void {
		...
		$this->assertStringContainsString( 'wp_wpsec_maintenance_notes', $joined );
	}
